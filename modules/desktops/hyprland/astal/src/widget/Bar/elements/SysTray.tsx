...
function AudioSlider() {
  ...
  return (
    <menubutton direction={Gtk.ArrowType.RIGHT} valign={Gtk.Align.CENTER}>
...
function Wifi() {
  ...
  if (wired.as(Boolean)) {
    content = wired.as(
      (wired) =>
        wired && (
          <image tooltipText="Wired" iconName={bind(wired, "iconName")} />
        ),
    );
    ...
    content = wifi.as(
      (wifi) =>
        wifi && (
          <image tooltipText="Disconnected" iconName={bind(wifi, "iconName")} />
        ),
    );
  }
